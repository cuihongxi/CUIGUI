...
/*
*   2020年2月14日19:59:46
*   HAL库移植中，注意LCD_TypeDef的类型中的数据不可被编译器优化的
*/
...
#define LCD_Bk_GPIO     LCD_Bk_GPIO_Port,LCD_Bk_Pin //LCD背光  PB0 


//LCD地址结构体
typedef struct
{
	vu16 LCD_REG;       // 在移植正点原子驱动的时候，该处的类型一定不要被编译器优化
	vu16 LCD_RAM;       // 在移植正点原子驱动的时候，该处的类型一定不要被编译器优化
} LCD_TypeDef;
